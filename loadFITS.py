...
#Optional parameters: 
#    'newFolder': indicates that you want to create a new output product folder (in the same directory as the fits files folder)
#    'moveFileName' = filename:  indicates that you want to move the named file into the output product folder
#Note: if you are making a new dir (newFolder): files_path is the fits files location
#      if you are moving files to the output folder (moveFileName): files_path is the location of the output folder
